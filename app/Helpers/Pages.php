...
class Pages
{
    ...
    public function setPage($title, $route, $icon = '',$size = 17)
    {
        $active = Route::is($route) ? 'class="active"' : null;
        echo "<li $active><a class='nav-link' href=' " . route($route) . " '><i class=' $icon' style='font-size: ".$size."px;'></i> <span> $title </span></a></li>";
    }
