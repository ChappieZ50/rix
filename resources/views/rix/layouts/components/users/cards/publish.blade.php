<div class="post-publish w-100">
    <div class="form-group m-3 d-inline-block">
        <div class="custom-control custom-radio">
            <input type="radio" id="role1" name="role" class="custom-control-input" value="admin">
            <label class="custom-control-label" for="role1">Yönetici</label>
        </div>
    </div>
    <div class="form-group m-3 d-inline-block">
        <div class="custom-control custom-radio">
            <input type="radio" id="role2" name="role" class="custom-control-input" value="editor">
            <label class="custom-control-label" for="role2">Yazar</label>
        </div>
    </div>
    <div class="form-group m-3 d-inline-block">
        <div class="custom-control custom-radio">
            <input type="radio" id="role3" name="role" class="custom-control-input" value="user" checked>
